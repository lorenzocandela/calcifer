<div style="display:flex;flex-direction:column;gap:14px;padding:20px 16px 0;animation:pageIn .26s cubic-bezier(.16,1,.3,1) both">
  ...
  <div style="display:flex;flex-direction:column;align-items:center;gap:10px;padding:8px 0">
    <label for="avatar-upload" style="cursor:pointer;position:relative;display:block">
      <div id="profile-avatar" style="
        ...
        font-size:1.5rem;font-weight:900;color:rgba(255,255,255,.7);
  ...
  <button id="profile-logout-btn" style="
    ...
    border:1.5px solid var(--red-soft);background: var(--red-soft);
    color:var(--red);font-size:.9375rem;font-weight:800;font-family:var(--sans);
    cursor:pointer;letter-spacing:-.01em;
    display:flex;align-items:center;justify-content:center;gap:8px;
    transition:background .13s;
  " onmouseenter="this.style.background='var(--red-soft)'" onmouseleave="this.style.background='transparent'">
